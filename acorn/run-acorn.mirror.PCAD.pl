...
# April 2000
#
#   last update Oct 27, 2015    TI
#
#----------------------------------------------------------------------

$uid        = "mta";
$work_dir   = "/data/mta/www/MIRROR/SOH/PCAD";
$exc_dir    = "$work_dir/Exc";
$script_dir = "/data/mta_www/MIRROR/SOH/Scripts";
$pid_file   = "$exc_dir/racorn.pid";
@acorn      = qw(/home/ascds/DS.release/bin/acorn);
$acorn_exe  = (-e $acorn[0])? $acorn[0] : $acorn[1];
$UDP_port   = "11521";                              #--- colossus-v
$msids      = "$script_dir/pcad-msids.list";
$filesize   = 500;
#
