...
$uid       = "mta";
$work_dir  = "/data/mta/www/MIRROR/SOH";
...
$UDP_port  = "11520";                               #--- colossus-v
$msids     = "$script_dir/soh-msids.list";
$filesize  = 500;
#
...
#
#--- use custom IPCL dir to get uncalibrated SHLDART, DETART, but everything else calibrated
#
...
#@ipcl = qw(/data/mta/www/MIRROR/Snap/Scripts/P009 /home/ascds/DS.release/config/tp_template/P011/ /home/ascds/swolk/IPCL/P008 /home/swolk/acorn/ODB);
